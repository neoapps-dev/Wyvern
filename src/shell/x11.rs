...
impl<BackendData: Backend> XWaylandShellHandler for WyvernState<BackendData> {
    fn xwayland_shell_state(&mut self) -> &mut XWaylandShellState {
        &mut self.xwayland_shell_state
    }
}

impl<BackendData: Backend> XwmHandler for WyvernState<BackendData> {
    ...
    fn resize_request(
        ...
        // luckily Wyvern only supports one seat anyway...
