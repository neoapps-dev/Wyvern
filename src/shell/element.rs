...
use crate::{focus::PointerFocusTarget, state::Backend, WyvernState};
...
impl<BackendData: Backend> PointerTarget<WyvernState<BackendData>> for SSD {
    fn enter(
        &self,
        _seat: &Seat<WyvernState<BackendData>>,
    ...
    fn frame(&self, _seat: &Seat<WyvernState<BackendData>>, _data: &mut WyvernState<BackendData>) {}
    fn leave(
        &self,
        _seat: &Seat<WyvernState<BackendData>>,
        _data: &mut WyvernState<BackendData>,
...
impl<BackendData: Backend> TouchTarget<WyvernState<BackendData>> for SSD {
    fn down(
        &self,
        seat: &Seat<WyvernState<BackendData>>,
        data: &mut WyvernState<BackendData>,
