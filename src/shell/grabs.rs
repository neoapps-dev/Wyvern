...
pub struct PointerMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: PointerGrabStartData<WyvernState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> PointerGrab<WyvernState<BackendData>>
    for PointerMoveSurfaceGrab<BackendData>
{
    fn motion(
        &mut self,
        data: &mut WyvernState<BackendData>,
        handle: &mut PointerInnerHandle<'_, WyvernState<BackendData>>,
    ...
    fn start_data(&self) -> &PointerGrabStartData<WyvernState<BackendData>> {
        &self.start_data
    }

    fn unset(&mut self, _data: &mut WyvernState<BackendData>) {}
}

pub struct TouchMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: TouchGrabStartData<WyvernState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> TouchGrab<WyvernState<BackendData>>
    for TouchMoveSurfaceGrab<BackendData>
{
    fn down(
        &mut self,
        _data: &mut WyvernState<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, WyvernState<BackendData>>,
        _focus: Option<(
            <WyvernState<BackendData> as smithay::input::SeatHandler>::TouchFocus,
            Point<f64, Logical>,
        )>,
    ...
    fn up(
        &mut self,
        data: &mut WyvernState<BackendData>,
        handle: &mut smithay::input::touch::TouchInnerHandle<'_, WyvernState<BackendData>>,
    ...
    fn start_data(&self) -> &smithay::input::touch::GrabStartData<WyvernState<BackendData>> {
        &self.start_data
    }
